...
function Lessons() {
    return (
        <div>
            ...
            <h3>Savings Bundles</h3>
            <p>We offer bundles to help you save. More lessons = more savings! Pay in advance.</p>
            <ul>
            ...
            <h3>Scheduling</h3>
            <p>We offer lessons Sunday - Friday with afternoon and evening times available. After your Introduction Lesson, we will find a time and day that fits your needs. Riders can choose days per week on a recurring basis. </p>
        </div>
    );
}
